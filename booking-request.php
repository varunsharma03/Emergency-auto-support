...
require_once 'C:/xampp/htdocs/vehicleassitancems/twilio-php-7.3.0/src/Twilio/autoload.php';
...
$accountSid = 'ACf552d811ff30255cf16105750e3ec4cb';
$authToken = '763871a8bd423e42e119049c932b6fe9';
$twilioNumber = '+15855342333';

$smsMessage = "New form submission from $name ($email):\nMessage succlessfully sent";
...
$client->messages->create(
   ...
   "+91"+$_POST['phone'], // User's phone number
    array(
        'from' => $twilioNumber,
        'body' => $smsMessage
    )
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="client-address">
                            ...
                            <div class="client-address-form">
                                ...
                                <a href="#" id="location-link">Get Current Location Link</a>
    <a href="#" id="location">My Location</a>
